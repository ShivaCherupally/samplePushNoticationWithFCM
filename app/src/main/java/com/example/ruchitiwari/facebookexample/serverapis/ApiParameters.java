...
public class ApiParameters {
    ...
    public static Map<String, String> repeatOrder(String order) {
        Map<String, String> params = new HashMap<String, String>();
...
//Rate us Details
    public static Map<String, String> getRateusSuccess(String ptnt_cd, String p_rating, String p_feedBack, String p_deviceId, String p_os_version,
        ...
        params.put("P_OS_VERSION", p_os_version);
        params.put("P_OS_TYPE", p_os_type);
        params.put("P_APP_VERSION", p_app_version);
    ...
    public static Map<String, String> passGetReports(String ptntcode, String pwd) {
        Map<String, String> params = new HashMap<String, String>();
    ...
    public static Map<String, String> getPdfReports(String city, String acc, String ptntcode, String mobile, String str,
        ...
        params.put("P_OSVERSION", osver);
        params.put("P_MYSRL_VERSION", mysrlver);
    ...
    /*public static Map<String, String> userRegistration(String salutation, String fname, String lname, String dob, String years,
        ...
        params.put(Constants.IN_OSVERSION, StringUtil.getValidString(osversion));
        params.put(Constants.IN_MYSRLVER, StringUtil.getValidString(mysrlver));
