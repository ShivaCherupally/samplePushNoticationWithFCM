...
import com.example.ruchitiwari.facebookexample.NetworkConnectivity;
import com.example.ruchitiwari.facebookexample.Validate;
...
public class ApiRequestManager
{
	...
	public void sendRequest(Context context, ApiRequest request, ApiResponseListener listener)
	{
		if (NetworkConnectivity.isOnline(context))
		{
			...
			request.sendRequest(new ResponseCallBack(context, listener));
	...
	private class ResponseCallBack implements ApiResponseListener<String>
	{
		...
		public ResponseCallBack(final Context context, final ApiResponseListener listener)
		{
			mContext = context;
			mListener = listener;
		}
