//package com.example.ruchitiwari.facebookexample.constants;
//
///**
...
//				if(result!=null) mResultListener.onLatLngReceive(result.lat/1E6, result.lng/1E6);
...
//				if (addresses.size() > 0){
//					p= new Barcode.GeoPoint(0,
//							(double) (addresses.get(0).getLatitude() * 1E6),
